...
const Portfolio = () => {
  ...
  return (
    <div className="lg:w-1/2 flex max-sm:flex-col p-0.5 lg:h-64 h-fit bg-white shadow-sm transition ease-in-out hover:ring-4 ring-blue-400 ring-offset-slate-50 rounded-md">
